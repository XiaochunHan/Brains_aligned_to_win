...
saveRDS(acc_all_perm, "SVM_win_all_perm_5000_oneF.RData")
saveRDS(acc_ins_bins_perm, "SVM_win_INS_BINS_perm_5000_oneF.RData")
saveRDS(acc_bold_fc_perm, "SVM_win_BOLD_FC_perm_5000_oneF.RData")
```

### Permutation read
```{r perm_read_succ}
acc_all_perm = readRDS("SVM_win_all_perm_5000_oneF.RData")
acc_ins_bins_perm = readRDS("SVM_win_INS_BINS_perm_5000_oneF.RData")
acc_bold_fc_perm = readRDS("SVM_win_BOLD_FC_perm_5000_oneF.RData")
colnames(acc_all_perm) = 'acc_perm'
colnames(acc_ins_bins_perm) = 'acc_perm'
colnames(acc_bold_fc_perm) = 'acc_perm'
```

### Permutation p value
```{r Summary_R2_succ}
p_perm_list <- list(
  p_perm_all = mean(acc_all<acc_all_perm$acc_perm),
  p_perm_intra = mean(acc_bold_fc<acc_bold_fc_perm$acc_perm),
